...
export default function SocietyDetails( { society, universityName } : { society: SOCIETY, universityName: string }) {
    ...
    return (
        ...
        <div className="border-2 border-gray-200 shadow-lg bg-white p-6 rounded-2xl w-[30dvw] min-w-[30dvw] max-w-[30dvw] h-auto flex flex-col justify-between transition-transform hover:scale-105 duration-200">
            <div>
